 ...
 *
 * This module re-exports every user-facing API of the hurstify library. It is
 * the only file consumers should normally import from when using the package
 * (`import {Hurstify} from 'hurstify';`). The intent is to keep a stable surface
 ...
 *
 * The Hurstify estimator itself depends only on `stats.js`,
