 ...
 *   the minimized KS distance returned by `Hurstify.estimateSingle`.
 * - CUSUM-based structural break detection for series of H estimates
 *   (e.g. from `Hurstify.rolling`).
 ...
 *
 * @param {number} D Minimized KS distance from `Hurstify.estimateSingle`
