...
export class KsObjective {
   ...
   *
   * @param {Array<Float64Array>} _sortedSamples One pre-sorted sample per
   *   scale (each of equal length).
   * @param {Array<number>} _scales Scale values matching `sortedSamples`.
   * @param {number} _H Trial Hurst parameter.
   * @return {number} Non-negative objective value.
   * @abstract
   */
  evaluate(_sortedSamples, _scales, _H) {
